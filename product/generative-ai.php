            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-4 innerBanner_left">
                        ...
                        <h1>Generative AI</h1>
                        <h2>Harness the power of next-generation automation where Generative AI doesn't just execute
                    ...
                    <div class="col-md-3">
                        <div class="workflowAutomationBox commonBorder">
                            ...
                            <p>Adaptive learning empowers AI Agents to improve with every interaction, enabling more
                                natural, human-like conversations for smoother and more helpful online experiences. </p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="workflowAutomationBox commonBorder">
                            ...
                            <p>Experience the power of choice with our intelligent automation platform that seamlessly
                                orchestrates multiple Large Language Models to tackle your unique business challenges;
                                Use specialized LLMs for specialized tasks, all through one seamless interface</p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="workflowAutomationBox commonBorder">
                            ...
                            <p>Multi-channel integration delivers a seamless, consistent experience across platforms,
                                enhancing brand loyalty by unifying AI Agents across social media, websites, and apps.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-3">
