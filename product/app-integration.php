                ...
                <div class="container">
                    <div class="row align-items-center mb-84">
                        <div class="col-md-6">
                            ...
                            <p>AIRA Intelligent Automation Solution seamlessly integrates with Input/Output source
                                systems
                                </br>
                                AIRA Integration framework includes Native connectors for an ever-increasing list of IT
                                systems. This ensures quick and efficient connectivity with these systems for data
                    ...
                    <div class="row align-items-center mb-84">
                        ...
                        <div class="col-md-6">
                            ...
                            <p> For systems not yet having Native connectivity with AIRA, a plug-and-play
                                integration/adaptation layer consisting of a wide range of connectivity options is made
                                available.</p>
                        </div>
                    </div>
                </div>
