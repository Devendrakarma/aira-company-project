<header class="header position-fixed w-100">
    <div class="headerTop text-center d-md-block d-none">
        <div class="container">
            <p class="mb-0">✨ An All-in-One Intelligent Solution for Your Business Needs</p>
        </div>
    </div>
    <nav class="navbar navbar-expand-lg">
        <div class="container container-1760">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="dropdownItem">
                                            <a
                                                href="<?php echo BASE_URL ?>/product/intelligent-document-processing.php">
                                                <span class="dropdownItem_icon">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul class="list-unstyled">
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/industries/manufacturing.php">
                                                        <span class="dropdownItem_icon">
                                                ...
                                                <li class="dropdownItem">
                                                    <a href="<?php echo BASE_URL ?>/solutions/industries/telecom.php">
                                                        ...
                                                        <span class="dropdownItem_text">Telecom</span>
                                                    </a>
                                                </li>
                                                <li class="dropdownItem">
                                                    <a href="<?php echo BASE_URL ?>/solutions/industries/retail.php">
                                                        ...
                                                        <span class="dropdownItem_text">Retail</span>
                                                    </a>
                                                </li>
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/industries/healthcare.php">
                                                        <span class="dropdownItem_icon">
                                                            <em class="icon-heart-pulse"></em>
                                                        </span>
                                                        <span class="dropdownItem_text">Healthcare</span>
                                                    </a>
                                                </li>
                                                <li class="dropdownItem">
                                                    <a href="<?php echo BASE_URL ?>/solutions/industries/pharma.php">
                                                        ...
                                                        <span class="dropdownItem_text">Pharma</span>
                                                    </a>
                                                </li>
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/industries/hospitality.php">
                                                        <span class="dropdownItem_icon">
                                                            <em class="icon-bed"></em>
                                                        </span>
                                                        <span class="dropdownItem_text">Hospitality</span>
                                                    </a>
                                                </li>
                                                <li class="dropdownItem">
                                                    <a href="<?php echo BASE_URL ?>/solutions/industries/textiles.php">
                                                        ...
                                                        <span class="dropdownItem_text">Textiles</span>
                                                    </a>
                                                </li>
                                                <li class="dropdownItem">
                                                    <a href="<?php echo BASE_URL ?>/solutions/industries/oil-gas.php">
                                                        ...
                                                        <span class="dropdownItem_text">Oil & Gas</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul class="list-unstyled">
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/departments/datacenter.php">
                                                        <span class="dropdownItem_icon">
                                                ...
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/departments/it-department.php">
                                                        <span class="dropdownItem_icon">
                                                ...
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/departments/sales-and-marketing.php">
                                                        <span class="dropdownItem_icon">
                                                ...
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/departments/customer-support.php">
                                                        <span class="dropdownItem_icon">
                                                ...
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/departments/logistics.php">
                                                        <span class="dropdownItem_icon">
                                                ...
                                                <li class="dropdownItem">
                                                    <a
                                                        href="<?php echo BASE_URL ?>/solutions/departments/supply-chain.php">
                                                        <span class="dropdownItem_icon">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="<?php echo BASE_URL ?>/product/app-integration.php" class="learnMore">Learn More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="dropdown-menu">
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="list-unstyled">
                                        <li class="dropdownItem">
                                            <a href="https://wiki.aira.fr/" target="_blank">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-document"></em>
                                                </span>
                                                <span class="dropdownItem_text">Documentation</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/resources/blogs.php">
                                                ...
                                                <span class="dropdownItem_text">Blogs</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/resources/whitepaper.php">
                                                ...
                                                <span class="dropdownItem_text">Whitepaper</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/resources/brochures.php">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-book-open"></em>
                                                </span>
                                                <span class="dropdownItem_text">Brochures</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/resources/case-study.php">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-file-search"></em>
                                                </span>
                                                <span class="dropdownItem_text">Case Studies</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="dropdown-menu">
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="list-unstyled">
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/company/about-us.php">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-users-group-alt"></em>
                                                </span>
                                                <span class="dropdownItem_text">About Us</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/company/careers.php">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-hand-holding-user"></em>
                                                </span>
                                                <span class="dropdownItem_text">Careers</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/company/contact-us.php">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-phone-call"></em>
                                                </span>
                                                <span class="dropdownItem_text">Contact Us</span>
                                            </a>
                                        </li>
                                        <li class="dropdownItem">
                                            <a href="<?php echo BASE_URL ?>/company/press-releases.php">
                                                <span class="dropdownItem_icon">
                                                    <em class="icon-newspaper"></em>
                                                </span>
                                                <span class="dropdownItem_text">Press Releases</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="headerBtn order-2 order-lg-3 d-flex align-items-center ms-auto me-lg-0 me-3">
                ...
                <a href="<?php echo BASE_URL ?>/free-trial.php"
